/**
 * Sample partner seed data. Imported by scripts/migrate-sample-data.ts to
 * seed Supabase. The app no longer reads from this file at runtime — see
 * src/lib/data/partners.ts for the runtime data path.
 *
 * Domain types live in src/lib/data/types.ts. UI/static data lives in
